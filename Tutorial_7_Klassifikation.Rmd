...
Accuracy is around `r round(colMeans(evalMeasures)[5], digits = 2)`%, F-measure is around `r round(colMeans(evalMeasures)[4], digits = 2)`%. Let's try some approaches to optimize the automatic classification.
